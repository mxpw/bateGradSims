...
sampled_fertilized_eggs = sampling_fixed(fertilized_eggs, n_males, by_female_samples = 15, undercount_female = 'keep')
get_sexual_selection_components(fertilized_eggs = fertilized_eggs,
                                sampled_fertilized_eggs = sampled_fertilized_eggs,
                                n_males = n_males)
...
Once sampled eggs are available (__sampled_fertilized_eggs__ here), sexual selection base variable can be computed using __get_sexual_selection_components()__ function. It will return MS/RS for females and males. Note that paternity share can be (and is, by default) considered. Both __fertilized_eggs__ (before sampling) and __sampled_fertilized_eggs__ (after sampling) should be provided since females RS depends on eggs before sampling (and this should be know to compute male RS while considering paternity share). 
